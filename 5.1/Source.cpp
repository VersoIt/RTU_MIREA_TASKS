...
int main()
{
	...
	cout << "Введите текущее основание счисления: ";
	cin >> base_radix;
	...
	cout << "Введите новое основание счисления: ";
	cin >> new_radix;

	try
	{
		cout << "Great! Ваш результат равен " << convert(original_number, base_radix, new_radix) << endl;
	}
	catch (exception e)
	{
		cout << e.what() << endl;
